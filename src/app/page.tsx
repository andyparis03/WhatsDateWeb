        ...
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-title text-primary flex items-center justify-center mb-4">
            ...
            <span className="hidden md:inline mx-4">
              <Image src="/whatsdate logo no bkgd.png" alt="WhatsDate Logo" width={80} height={80} className="inline-block h-20 w-20 object-contain" />
            </span>
            <span className="md:hidden">
              <Image src="/whatsdate logo no bkgd.png" alt="WhatsDate Logo" width={80} height={80} className="inline-block h-16 w-16 object-contain" />
            </span>
