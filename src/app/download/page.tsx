  ...
  return (
    <div className="w-full flex flex-col items-center py-16 px-4">
      <motion.h1 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="text-4xl md:text-6xl font-extrabold mb-6 text-wa-green drop-shadow-wa-glow text-center">
        Download <span className={theme === 'light' ? 'text-black' : 'text-white'}>WhatsDate Beta</span>
      </motion.h1>
      <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.7 }} className={`text-lg md:text-xl max-w-2xl mb-8 text-center ${
        theme === 'light' ? 'text-wa-dark' : 'text-neutral-300'
      }`}>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-10">
        <motion.a whileHover={{ scale: 1.08, boxShadow: '0 0 16px #25D366' }} href="https://github.com/WhatsDate/WhatsDate/releases/tag/v.0.0.1" target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 px-8 py-4 rounded-full bg-wa-green text-xl font-bold shadow-wa transition-all hover:scale-105 hover:shadow-wa-glow ${
          theme === 'light' ? 'text-wa-dark' : 'text-white'
        }`}>
          <FaWindows size={28} /> Download for Windows
        </motion.a>
        <motion.a whileHover={{ scale: 1.08, boxShadow: '0 0 16px #25D366' }} href="#" className={`flex items-center gap-3 px-8 py-4 rounded-full text-xl font-bold shadow-wa transition-all opacity-60 cursor-not-allowed ${
          theme === 'light' ? 'bg-wa-green-light text-black' : 'bg-neutral-800 text-white'
        }`}>
      ...
      <div className="flex justify-center mb-10">
        <motion.a whileHover={{ scale: 1.08, boxShadow: '0 0 16px #333' }} href="https://github.com/WhatsDate/WhatsDate/releases/tag/v0.0.1-beta" target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 px-8 py-4 rounded-full text-xl font-bold shadow transition-all hover:scale-105 hover:shadow-lg border border-wa-green ${
